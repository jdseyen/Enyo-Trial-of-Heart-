...
public class Act3StoryPager : MonoBehaviour
{
    ...
    public void NextPage()
    {
        ...
        // If there is still another text to display,
        // don't move to the next page yet.
        if (!allTextsComplete)
        {
            Debug.Log(
                "More text remains on this page."
            );
        ...
        // Last page ¡ú load Act 3 Platform Scene
        if (currentPage >= pages.Length - 1)
        {
            StartCoroutine(
                FadeAndLoadScene("ACT_3_PlatformScene")
            );
